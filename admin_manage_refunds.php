...
include 'MVC/user_routes.php';
    ...
    if(isset($_GET['remove']) && isset($_GET['user_ID'])) {
        $reservationcontrol->refundpayment($_GET['remove'], $_GET['user_ID']);
    }
    ...
    $fetchuntracked = $reservationcontrol->fetchrefundall();
?>
...
<head>
    ...
    <style>
        ...
        .modal-body .image-container {
            ...
            margin: 0 auto 20px;
            border: 3px solid #6B4A4A; /* Add a border */
        }
...
<body>
    ...
    <div class="main_content1">
        ...
        <div class="container container-flex">
            <div>
                <div class="title">Manage Appointments (Refund Request)</div>
                <div class="subtitle">Quick access to customers appointment</div>
            </div>
            <div style="margin-left: auto;">
                <a href="admin_manage_appointments.php"><button class="back-button">Back</button></a>
            </div>
        </div>
        <!-- TEMPLATE -->
                                                        ...
                                                        <table class="table table-striped mb-0">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class=""><?php echo $untracked['reservation_payment']; ?></td>
                                                                    <td class="hidd"><?php echo date('F j, Y, g:i A', strtotime($untracked['reservation_datetime'])); ?></td>
                                                                    <td class="hidd"><a href="https://checkout.paymongo.com"><button class="click-button" data-bs-toggle="modal">View</button></a></td>
                                                                    <td class="hidd"><a href="admin_manage_refunds.php?remove=<?php echo $untracked['reservation_ID']; ?>&user_ID=<?php echo $untracked['user_IDFK']; ?>"><button class="click-button" data-bs-toggle="modal">Remove</button></a></td>
                                                                </tr>
                                                                <?php endforeach ?>
                                                            </tbody>
                                                        </table>
