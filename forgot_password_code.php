        ...
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="col-6">
                <div style="height: 100%; padding: 10px;">
                    <div style="margin-top: 20px; margin-bottom: 20px; text-align: center; font-size: 20px;">Enter Forgot Password Code</div>
                    <div style="margin-top: -10px; margin-bottom: 20px; text-align: center; font-size: 15px; color: #797979;">Enter forgot password code or click the link directly.</div>
                    <form action="verify_account.php" method="post" style="margin-top: 70px;">
                        ...
                        <button type="submit" name="forg" class="btn btn-primary" style="background-color: #AC1515; color: #FFE141; margin-left: 50%; transform: translate(-50%);">Submit</button>
                    </form>
