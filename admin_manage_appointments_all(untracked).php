...
include 'MVC/user_routes.php';
    ...
    $fetchuntracked = $reservationcontrol->getalluntrackedreservation();
?>
                                            ...
                                            <div class="modal-dialog moddd" style="max-width: 500px;">
                                                ...
                                                <div class="modal-body">
                                                    <div class="container" style="width: 250px; height: 250px; border: 1px solid #ccc;">
                                                        <img src="<?php echo disp($untracked); ?>" class="img-fluid" alt="Responsive image">
                                                    </div>
                                                    <div>
                                                        
                                                    </div>
                                                    <div style="font-size: 25px; margin-left: 50%; transform: translate(-50%); text-align: center;">
                                                        <?php echo $untracked['user_fullname']; ?>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6" style="font-size: 25px; color: #828282;">
                                                            <?php echo $untracked['user_number']; ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">              <!-- PASS ID AS GET -->
                                                    <a href="admin_manage_appointments_specificuser(untracked).php?id=<?php echo $untracked['reservation_ID']; ?>"><button type="button"  data-bs-toggle="modal" data-bs-dismiss="modal" class="btn">View Reservation</button></a>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
