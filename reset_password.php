                ...
                <div style="height: 100%; padding: 10px;">
                    ...
                    <form action="your-login-handler.php" method="post">
                        <div class="mb-3">
                            ...
                            <input type="password1" id="password1" name="passwordreset1" class="form-control" placeholder="Enter your password" required>
                        </div>
                        <div class="mb-3">
                            <label for="password2" class="form-label">Confirm New Password</label>
                            <input type="password2" id="password2" name="passwordreset2" class="form-control" placeholder="Enter your password" required>
                        </div>
