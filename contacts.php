...
<body style="background-color: #FFF0F0;" >
    ...
    <div class="container" style="margin-top: 80px;">
        <div style="display: flex; margin-top: 20px;">
            <div style="border-left: 5px solid; color: #AC1515; height: 40px; margin-top: 5px; "></div>
            <div style="margin-left: 10px; font-family: Inter; font-size: 40px; font-weight: 500; line-height: 54.53px; letter-spacing: 0.06em; text-align: left; text-underline-position: from-font; text-decoration-skip-ink: none;">Contact Number:
            </div>
        </div>
        <div style="display: flex; justify-content: end;">
            <div style="margin-top: -70px;">
                <span style="font-size: 30px;">0916-958-7504</span>
                <br>
                <span style="font-size: 30px;">0919-359-6831</span>
            </div>
        </div>
    ...
    <div class="container" style="margin-top: 80px;">
        <div style="display: flex; margin-top: 20px;">
            <div style="border-left: 5px solid; color: #AC1515; height: 40px; margin-top: 5px; "></div>
            <div style="margin-left: 10px; font-family: Inter; font-size: 40px; font-weight: 500; line-height: 54.53px; letter-spacing: 0.06em; text-align: left; text-underline-position: from-font; text-decoration-skip-ink: none;">Facebook Page:
            </div>
        </div>
        <div style="display: flex; justify-content: end;">
            <div style="margin-top: -70px;">
