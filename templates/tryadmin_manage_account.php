...
<body>
    ...
    <!-- TEMPLATE -->
        ...
        <div class="container border border-primary" style="margin-top: 30px; display: flex;">
            <div class="border border-danger" style="width: 50%;">
        ...
        <div class="container border border-danger" style="margin-top: 50px;">
            <div class="row">
                <div class="col-9 border-primary" style="border: 1px solid;">
